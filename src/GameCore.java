...
public class GameCore implements GameCoreInterface {
    ...
    public GameCore(String playerAccountsLocation, String worldFile) throws Exception {
        ...
        map = new Map(worldFile); //Updated to accept more maps
        ...
        Thread objectThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                while(true) {
                    try {
                        Thread.sleep(rand.nextInt(90000));	//Slowed by cwells21 as sprint 101 Slowed the rate of students to 1 ever 1.5 minutes 
