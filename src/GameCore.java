 ...
 * 
   ...
   /**
    ...
    /*
    todo    - Feature idea - live update chat preferences.
            - Call method to parse chat preferences and store them appropriately.
            - Remove similar reads in GameClient, GameCore.joke, etc..
            - Call on client start
                and/or create input command,
                and/or check diff on local file on a cycle,
                and/or call from other feature (ie: joke)
     */
}
