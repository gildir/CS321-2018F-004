...
public interface GameObjectInterface extends Remote {
	...
	/**
	 * Sends a request to join the game. Returns with the status of the join. On
	 * true, the server expects the client will initiate a socket connection, to
	 * serve as an asynchronous, unsolicited String transfer mechanism.
	 * 
	 ...
	 * jokes, one per line. The command chooses a random joke.
	 * 
...
//Feature 411. Shout
	...
	/**
	 * Attempts to pick up an object < object >. Will return a message on any
	 * success or failure.
	 * 
	...
	/**
	 * Attempts to drop an object < object >. Will return a message on any success
	 * or failure.
	 * 
	...
	/**
	 * Attempts to sort the player's inventory. Will return a message on any success
	 * or failure.
	 * 
	...
	/**
	 * @author Team 4: King Lets player shop if in a shoppable area
	 * @param name Name of the player
	 * @return Returns the id of the shop the player just entered or -1 if they
	 *         can't shop
	 * @throws RemoteException
	 */
	...
	/**
	 * Player check in to ensure the client has not crashed. A client needs to call
	 * this method at least every hour or else it will be logged off.
	 * 
