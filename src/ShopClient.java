...
public class ShopClient {
    ...
    // prints menu of available commands for player while in the shop
    ...
    // returns formatted string of shops inventory
    public String getInv() throws RemoteException {
        return remote.getShopInv(this.id);
    }

    // returns formatted string of shops indemand inventory
