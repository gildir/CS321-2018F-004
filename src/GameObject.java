...
public class GameObject extends UnicastRemoteObject implements GameObjectInterface {
	...
	/**
	 * Attempts to walk in < direction > 1 time. If unable to, a message will be
	 * returned. Will display LOOK on any partial success.
	 * 
	 * @param name      Name of the player to move
	...
	/**
	 * Attempts to drop an object < target >. Will return a message on any success
	 * or failure.
	 * 
	 * @param name   Name of the player to move
	 * @param target The case-insensitive name of the object to pickup.
	...
	/**
	 * @author Group 4: King Lets player shop if in a shoppable location
	 * @param name Name of the player trying to shop
	 * @return Returns the shop the player just entered or Null if they couldnt
	 *         enter one
	 * @throws RemoteException
	 */
	...
	/**
	 * @author Group 4: King Returns the Player object from the name
	...
	/**
	 * @author Team 4: King Returns a string representation of how much money a
	 *         player has
	 */
