...
<<<<<<< HEAD
	 ...
	 * 
	 * @param newFilteredWords - collection of words to be filtered from this
	 *                         player's chat
	 */
	 ...
	 * @return - whether player reference was successfully added to set
	 *         ignorePlayer.
	 */
	...
	/**
	 * Checks a given other player to see if they're on the THIS player's ignore
	 * list.
	 * 
	...
	public String getIgnoredPlayersList() {
		...
		if (ignoredPlayers.isEmpty()) {
			ignoredPlayersList.append(" Your ignore list is empty.\n");
		} else {
			int count = 1;
	 ...
	 * @return - whether or not the sent message was successfully added to the set
	...
	public boolean receiveMessage(Message sentMessage) {
		 ...
		 * 
		 * sentMessage.SetReceived(); received = true; }
		 */
...
<<<<<<< HEAD
	 ...
	 * @param intendedRecipient - A reference to the user the message is being sent
	 *                          to.
