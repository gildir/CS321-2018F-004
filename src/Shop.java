...
public class Shop {
    ...
    // short description of shop type for player to read in game
    private String description;

    // name of the shop to be displayed in game
    ...
    public Shop(String name, String desc) {
        ...
        // if borked, populate with original items in alpha game version
        catch(IOException e) {
